...
add_filter( 'body_class','page_class_structure' );
function page_class_structure( $classes ) {

    if ( is_page_template( 'template-primary_single.php' ) ) {
        $classes[] = 'primary';
    }
    if ( is_page_template( 'template-primary_two_column.php' ) ) {
        $classes[] = 'primary two-column';
    }
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'after_widget' => '</div>',
        'before_title' => '<div class="panel-heading"><h2><span class="ca-gov-icon-info"></span> ',
        'after_title' => '</h2></div>'
    ));
    ...
    register_sidebar(array(
        ...
        'after_widget' => '</div>',
        'before_title' => '<div class="panel-heading"><h4><span class="ca-gov-icon-info"></span>',
        'after_title' => '</h4></div>'
    ));
}
