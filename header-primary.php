<!DOCTYPE html>
<html <?php language_attributes(); ?> class="no-js <?php echo get_option('mytheme_color')?>">
	<head>
	...
	<body <?php body_class(); ?>>
		...
		<!-- header -->
		<header id="header" class="global-header header clear" style="background: url('<?php header_image(); ?>') no-repeat 40% 40%">
